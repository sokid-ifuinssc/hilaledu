...
@section('content')
<a href="{{ route('superadmin.siswa.index') }}" class="btn-back"><i class="bi bi-arrow-left"></i> Kembali</a>

<div class="import-card">
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;margin-bottom:16px;">
        <div>
            <div class="import-title"><i class="bi bi-file-earmark-spreadsheet me-2" style="color:#58d68d;"></i>Import Data Siswa</div>
            <div class="import-desc">Upload file Excel (.xlsx, .xls, .csv) berisi data siswa. Data duplikat akan otomatis diperbarui.</div>
        </div>
        <a href="{{ route('superadmin.siswa.template') }}" class="btn-template">
    ...
    <div class="info-box">
        ...
        <div class="mt-2 p-2 rounded" style="background:rgba(46,204,113,0.1);border:1px solid rgba(46,204,113,0.25);color:#58d68d;font-size:0.8rem;">
            <i class="bi bi-check-circle-fill me-1"></i> <strong>PENTING:</strong> Hanya kolom <strong>NIS/NISN</strong> yang wajib diisi (tidak boleh kosong). Semua kolom lainnya bersifat fleksibel / opsional. Jika Username/Email kosong, sistem akan membuatnya secara otomatis.
        </div>
        <div class="row g-2 mt-2">
            <div class="col-md-6">
                <ul class="mb-0">
                    <li><strong class="text-white">NIS/NISN</strong> <span class="badge bg-danger ms-1" style="font-size:0.65rem;">WAJIB</span></li>
                    <li><strong>Nama Lengkap</strong> (opsional)</li>
                    <li><strong>Username & Email</strong> (otomatis dibuat jika kosong)</li>
                    <li><strong>No HP Siswa & No HP Ortu</strong></li>
                    <li><strong>Nama Ayah & Nama Ibu</strong></li>
                </ul>
            </div>
            <div class="col-md-6">
                <ul class="mb-0">
                    ...
                    <li><strong>Pendidikan SD & SMP</strong> (+ Tahun Lulus)</li>
    ...
    <form method="POST" action="{{ route('superadmin.siswa.import.process') }}" enctype="multipart/form-data" id="importForm">
        @csrf
        ...
        <div class="mb-4 p-3 rounded-3" style="background:rgba(255,255,255,0.03);border:1px solid var(--border-color);">
            <label class="fw-bold text-light small mb-2 d-flex align-items-center gap-1">
                <i class="bi bi-arrow-repeat text-warning"></i> Jika Data Siswa Sudah Ada di Database (Berdasarkan NIS/Username):
            </label>
            <div class="d-flex flex-column gap-2 mt-2" style="font-size:0.83rem;">
                <label class="d-flex align-items-center gap-2 text-light" style="cursor:pointer;">
                    ...
                    <span><strong>Timpa / Perbarui Data (Update)</strong> <span class="text-muted">— (Rekomendasi) Perbarui data siswa lama dengan data dari Excel.</span></span>
                </label>
                <label class="d-flex align-items-center gap-2 text-light" style="cursor:pointer;">
                ...
                <label class="d-flex align-items-center gap-2 text-light" style="cursor:pointer;">
                    ...
                    <span><strong>Hapus yang Lama & Ganti Baru (Replace)</strong> <span class="text-muted">— Hapus data siswa lama dan buat baru dari Excel.</span></span>
                </label>
            </div>
        </div>
        ...
        <button type="submit" class="btn-import" id="btnImport" disabled>
            <i class="bi bi-upload"></i> Mulai Import Data Siswa
        </button>
    </form>
</div>
