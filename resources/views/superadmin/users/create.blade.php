...
.form-input {
    ...
    border: 1px solid var(--border-color);
    color: var(--text-light); border-radius: 12px;
    padding: 11px 16px; font-family: 'Poppins', sans-serif; font-size: 0.88rem;
...
<div class="form-page-header">
    ...
    <div>
        <h4 style="margin:0;font-size:1.1rem;font-weight:700;">Tambah Pengguna Baru</h4>
        <p style="margin:0;font-size:0.78rem;color:var(--text-muted);">Buat akun pengguna baru di sistem HilalEdu</p>
    </div>
</div>
        ...
        <div class="row g-3">
            <div class="col-md-12">
                ...
                <input type="text" name="name" class="form-input {{ $errors->has('name') ? 'is-invalid' : '' }}"
                       placeholder="Contoh: Ahmad Fauzi, S.Pd" value="{{ old('name') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="username" class="form-input {{ $errors->has('username') ? 'is-invalid' : '' }}"
                       placeholder="Contoh: ahmad.fauzi" value="{{ old('username') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="email" name="email" class="form-input {{ $errors->has('email') ? 'is-invalid' : '' }}"
                       placeholder="Contoh: ahmad@hilaledu.sch.id" value="{{ old('email') }}">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" class="password-toggle" onclick="togglePass('password','icon-pass1')">
                        <i class="bi bi-eye-fill" id="icon-pass1"></i>
                    </button>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" class="password-toggle" onclick="togglePass('password2','icon-pass2')">
                        <i class="bi bi-eye-fill" id="icon-pass2"></i>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <label class="toggle-switch">
                    ...
                    <div class="toggle-label">Akun Aktif</div>
                </label>
            </div>
        </div>
