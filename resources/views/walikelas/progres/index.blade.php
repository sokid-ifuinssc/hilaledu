...
@section('subtitle', 'Pelanggaran siswa yang membutuhkan aksi Anda')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
        <form method="GET" class="flex flex-wrap gap-3 items-end">
            ...
            <a href="{{ route('walikelas.progres.index') }}" class="btn-secondary text-sm">Reset</a>
        </form>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                @forelse($progresList as $progres)
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4">{{ $p->jenisPelanggaran->nama ?? '-' }}</td>
                        ...
                        <td class="py-3 px-4">
                            ...
                            @elseif($progres->requiresLaporanFrom('walikelas') && empty($progres->laporan_walikelas))
                        ...
                        <td class="py-3 px-4"><a href="{{ route('walikelas.progres.show', $p) }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">Detail →</a></td>
                    </tr>
                @empty
